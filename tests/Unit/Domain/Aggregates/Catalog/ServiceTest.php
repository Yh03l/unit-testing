...
class ServiceTest extends TestCase
{
	...
	protected function setUp(): void
	{
		...
		$this->defaultTipoServicioId = 'asesoramiento';
		$this->defaultCost = new ServiceCost(100.0, 'BOB', new DateTimeImmutable('2024-12-31'));
	...
	public function testCreateValidService(): void
	{
		...
		$this->assertEquals(
			$this->defaultTipoServicioId,
			$this->service->getTipoServicio()->toString()
		);
	...
	{
		$newCost = new ServiceCost(150.0, 'BOB', new DateTimeImmutable('2025-01-01'));
	...
	public function testUpdateCostThrowsExceptionWhenServiceIsNotActive(): void
	{
		...
		$this->expectExceptionMessage(
			'No se puede actualizar el costo del servicio en su estado actual'
		);
