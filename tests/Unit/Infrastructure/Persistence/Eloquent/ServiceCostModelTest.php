...
class ServiceCostModelTest extends BaseModelTest
{
    ...
    public function test_scope_active_filters_correctly(): void
    {
        ...
        $this->assertTrue($activeCosts->contains('monto', 150.00));
        $this->assertTrue($activeCosts->contains('monto', 200.00));
    }
    ...
    public function test_scope_expired_filters_correctly(): void
    {
        ...
        $this->assertEquals(100.00, $expiredCosts->first()->monto);
    }
    ...
    public function test_scope_by_date_range_filters_correctly(): void
    {
        ...
        $this->assertTrue($costs->contains('monto', 100.00));
        $this->assertTrue($costs->contains('monto', 150.00));
        $this->assertTrue($costs->contains('monto', 200.00));
    }

    public function test_is_active_returns_correct_value(): void
    {
        // Arrange
        $activeCost = $this->createCost($this->service->id, 100.00, 'USD', Carbon::now()->addDay());
        $expiredCost = $this->createCost($this->service->id, 150.00, 'USD', Carbon::now()->subDay());
    ...
    public function test_get_next_active_cost_returns_correct_cost(): void
    {
        ...
        $this->assertEquals(150.00, (float)$nextCost->monto);
    }
    ...
    public function test_get_previous_cost_returns_correct_cost(): void
    {
        // Arrange
        $this->createMultipleCosts();
        $currentCost = ServiceCostModel::where('monto', 150.00)->first();
        ...
        $this->assertEquals(100.00, $previousCost->monto);
    }
    ...
    public function test_validate_vigencia_date_throws_exception_for_past_date(): void
    {
        ...
        $this->expectExceptionMessage('La fecha de vigencia no puede ser anterior a la fecha actual');
